...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,LoaderManager.LoaderCallbacks<String[]> {
    ...
    private static final int MAIN_LOADER_ID = 8;

    private static final String LOADER_PARAM_URL_KEY = "URL_PARAM";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Loader mainLoader = this.getSupportLoaderManager().initLoader(MAIN_LOADER_ID, null, this);
        loadWeatherData();
    }
    ...
    private void loadWeatherData() {
        ...
        Loader stringLoader = loaderManager.getLoader(MAIN_LOADER_ID);
        Bundle newBundle = new Bundle();
        newBundle.putString(LOADER_PARAM_URL_KEY, location);
        if (stringLoader == null) {
            loaderManager.initLoader(MAIN_LOADER_ID, newBundle, this);
        } else {
            loaderManager.restartLoader(MAIN_LOADER_ID, newBundle, this);
        }
    }
        ...
        Loader<String[]> newLoader = new AsyncTaskLoader<String[]>(this) {
            ...
            protected void onStartLoading() {
                ...
                if (mCachedResults != null) {
                    this.deliverResult(mCachedResults);
                } else {
            ...
            public void deliverResult(String[] data) {
                Log.d(TAG, "deliverResults was called");
                if (data != null) {
                    this.mCachedResults = data;
                }
