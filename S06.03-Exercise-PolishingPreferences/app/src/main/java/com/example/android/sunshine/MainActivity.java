...
public class MainActivity extends AppCompatActivity implements
    ...
    private static boolean mPrefUpdateFlag = false;
    ...
    private void openLocationInMap() {
        ...
        String addressString = sharedPreferences.getString(getString(R.string.pref_location_key),
