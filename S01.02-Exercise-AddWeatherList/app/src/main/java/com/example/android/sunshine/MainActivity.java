...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] weatherArray = {"Cold","Colder","Coldest","Maybe Rain?","Who knows?","Ask again later","Snow, because why not","100% chance of weather","Cloudy with a chance of meatballs","Cold again"};
